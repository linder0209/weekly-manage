...
angular.module('weeklyManageApp')
  .factory('weeklyHttpInterceptor', ['$q', function ($q) {
    return {
      // optional method
  ...
  .config(['$httpProvider', function ($httpProvider) {
    //为 $httpProvider 加入拦击器 weeklyHttpInterceptor
    $httpProvider.interceptors.push('weeklyHttpInterceptor');
  ...
  .factory('weeklyHttpService', ['$http', '$q', function ($http, $q) {// 创建 custom Http Service
    return {
